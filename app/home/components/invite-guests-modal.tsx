...
const InviteGuessModal = (props: InviteGuessModalProps) => {
    return (
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center p-4'>
            <div className='rounded-xl py-5 px-6 bg-zinc-900'>
                ...
                <form onSubmit={props.addNewEmailToInvite} className='mt-4 rounded-md flex-col justify-center items-center'>


                    <div className='flex gap-2 items-center justify-center p-2 bg-zinc-950'>
                    ...
                    <button
                        type='submit'
                        className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 w-full justify-center mt-4 hover:bg-lime-400">
                        Convidar
