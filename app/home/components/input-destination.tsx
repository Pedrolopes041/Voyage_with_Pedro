...
const InputDestination = ({isInputGuess, openGuessInput, closeGuessInput}: InputDestinationProps) => {
    return (
        <div className="px-4 rounded-xl flex flex-col items-center gap-3">
            ...
            {isInputGuess ? (
                <button onClick={closeGuessInput} className="bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center justify-center gap-2 w-full h-14 hover:bg-zinc-700">
                    Alterar local/data
                    <Settings2 />
                </button>
            ) : (
                <button
                    ...
                    className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center justify-center h-14 gap-2 w-full hover:bg-lime-400"
                >
                    Continuar
